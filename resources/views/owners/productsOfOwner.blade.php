        ...
        <div class="content" id="content">
            ...
            <div style="overflow-x:auto;" >
                ...
                <div class="form-group">
                    <label for="description">Satıcı ismine özel arama</label>


                    <select class="form-control" name="company">
                        <option value="" selected disabled hidden>Ürünlerini görüntülemek istediğiniz satıcıyı seçiniz</option>
                        <option>Apple</option>
                    ...
                    <button style="margin-top: 6px" class="btn btn-secondary btn-block">Getir</button>
                    <hr>
                </div>
            --}}
            </div>
